...
import { deleteCar, getAllCars } from '../redux/actions/carsAction.js';
    ...
    return (
        <DefaultLayout>
            ...
            <Row justify='center' gutter={16}>
                <Col lg={20} sm={24}>
                    <div className='d-flex align-items-center justify-content-between'>
                        ...
                        <button className='btn1 mt-2' ><Link to='/addcar'>ADD CAR</Link></button>
                    </div>
                </Col>
            </Row>
            ...
            <Row justify='center' gutter={16} key={cars._id} >
                {totalcars.filter(o => o.user === user._id).map(car => {
